    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8" style={{ color: theme.textSecondary }}>
      ...
      <div className="text-center py-12">
        <h1 className="text-3xl sm:text-4xl font-black mb-4 font-serif uppercase tracking-widest leading-tight" style={{ color: theme.textPrimary }}>
          {isMen ? <>How to Care for Men's Accessories</> : <>How to Care for Your Fashion Jewellery</>}
        </h1>
      </div>
      ...
      <article className="space-y-10">
        ...
        <section>
          ...
          >
            {isMen ? "Why Men's Accessories Degrade?" : "Why Fashion Jewellery Degrades?"}
          </h2>
          ...
          <div className="space-y-4">
            <div className="border p-5" style={{ backgroundColor: theme.cardBg, borderColor: theme.cardBorder }}>
              ...
              <p className="text-sm leading-relaxed" style={{ color: theme.textSecondary }}>
                {isMen ? (
                  "When metal is exposed to oxygen and moisture, it oxidizes. For copper-based kadas or cuffs, this produces copper carbonate. Sterling silver also oxidizes, but produces a dark vintage patina rather than green marks. Stainless steel and rhodium-plated chains are nearly immune to oxidation, which is why they last longer."
                ) : (
                  "When metal is exposed to oxygen and moisture, it oxidizes. For copper-based jewellery (which includes brass), this produces copper carbonate. Sterling silver also oxidizes, but produces a dark patina rather than green marks. Stainless steel and rhodium-plated pieces are nearly immune to oxidation, which is why they last longer."
                )}
              </p>
            </div>
            <div className="border p-5" style={{ backgroundColor: theme.cardBg, borderColor: theme.cardBorder }}>
              ...
              <p className="text-sm leading-relaxed" style={{ color: theme.textSecondary }}>
                {isMen ? (
                  "Gold or silver plating is a microscopically thin layer (0.5–2 microns) applied over the base metal. Every point of friction, link connections, cuffs rubbing against your work desk, watch buckle friction, or keys in your pocket slowly wears through this layer. Once the base metal is exposed, degradation accelerates rapidly."
                ) : (
                  "Gold or silver plating is a microscopically thin layer (0.5–2 microns) applied over the base metal. Every point of friction, clasps, areas where jewellery touches your desk, the spot where a ring touches adjacent fingers slowly wears through this layer. Once the base metal is exposed, degradation accelerates rapidly."
                )}
              </p>
            </div>
            <div className="border p-5" style={{ backgroundColor: theme.cardBg, borderColor: theme.cardBorder }}>
              ...
              <p className="text-sm leading-relaxed" style={{ color: theme.textSecondary }}>
                {isMen ? (
                  "Your skin's natural pH is slightly acidic (around 5.5). Sweat, aftershaves, beard oils, heavy colognes, soap, and chlorine in swimming pools all contain chemicals that attack plated surfaces."
                ) : (
                  "Your skin's natural pH is slightly acidic (around 5.5). Sweat, perfume, soap, hand sanitizer, chlorine in swimming pools, and even the detergent on your freshly washed clothes, all contain chemicals that attack plated surfaces."
                )}
              </p>
            </div>
          </div>
